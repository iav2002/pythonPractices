...
def deal_card(): #funcion para repartir cartas
...
#Todas las condiciones que se tienen que cumplir para que sea un juego funcional.
...
#if they want to restart the game. If they answer yes, clear the console and start a new game of blackjack and show the logo from art.py.
